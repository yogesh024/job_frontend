      ...
      <div className="mb-4">
        <nav className="bg-custom-white rounded-3 p-3">
          <ol className="flex flex-col space-y-2">
            <li className="bg-custom-blue text-wht rounded-lg py-2 px-4">Your Profile</li>
          </ol>
        </nav>
      </div>
            ...
            <div className="bg-custom-white shadow rounded-lg overflow-hidden mb-4">
              <div className="text-center p-4">
                <div className="mt-3 mb-4">
                  <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRB-r-33_9ZqU1sAITY2wlJNXYt-qkzsLszA&s"
